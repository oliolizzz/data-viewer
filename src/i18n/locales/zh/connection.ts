export const connection = {
  // 连接页面应用描述
  'app.tagline': '轻松查看和搜索您的数据',
  'app.description':
    '跨平台数据查看工具，支持 WebDAV、对象存储和本地文件系统，提供流式传输和虚拟滚动等强大功能，专为大数据设计。',

  // 功能特性
  'features.title': '核心功能',
  'features.large_files': '超大数据支持',
