export const connection = {
  ...
  'app.description':
    'Cross-platform data viewer supporting WebDAV, object storage, and local file systems with powerful features like streaming and virtual scrolling, designed for large datasets.',
